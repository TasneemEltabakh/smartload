...
| C1 Controller + oracle (new upper bound) | 99.7 ± 0.2 % | 212 ± 157 | 2689 ± 20 | 1.0 ± 0.0 | 0.0 ± 0.0 s |
| C2 Controller + MA forecast | 99.7 ± 0.2 % | 212 ± 157 | 2687 ± 20 | 1.2 ± 0.4 | 0.0 ± 0.0 s |
| C3 Controller + reactive (trailing mean) | 99.7 ± 0.2 % | 212 ± 157 | 2687 ± 20 | 1.2 ± 0.4 | 0.0 ± 0.0 s |
| C4 Controller + trend forecast | 99.7 ± 0.2 % | 212 ± 157 | 2688 ± 20 | 1.2 ± 0.4 | 0.0 ± 0.0 s |
| C5 Controller + calibrated-noise forecast | 99.6 ± 0.2 % | 248 ± 152 | 2438 ± 65 | 21.1 ± 4.8 | 0.0 ± 0.0 s |
| C6 Sqrt-staffing + trend forecast | 99.7 ± 0.2 % | 212 ± 157 | 2689 ± 20 | 1.0 ± 0.0 | 0.0 ± 0.0 s |
...
| C1 Controller + oracle (new upper bound) | 99.6 ± 0.1 % | 126 ± 32 | 2500 ± 32 | 14.2 ± 0.4 | 0.0 ± 0.0 s |
| C2 Controller + MA forecast | 98.3 ± 0.3 % | 385 ± 76 | 1875 ± 15 | 15.0 ± 0.0 | 0.1 ± 0.0 s |
| C3 Controller + reactive (trailing mean) | 98.3 ± 0.3 % | 385 ± 76 | 1875 ± 15 | 15.0 ± 0.0 | 0.1 ± 0.0 s |
| C4 Controller + trend forecast | 99.4 ± 0.2 % | 203 ± 155 | 2114 ± 68 | 22.9 ± 2.4 | 0.0 ± 0.0 s |
| C5 Controller + calibrated-noise forecast | 99.1 ± 0.4 % | 675 ± 487 | 2829 ± 112 | 44.4 ± 3.5 | 0.0 ± 0.0 s |
| C6 Sqrt-staffing + trend forecast | 99.3 ± 0.2 % | 1067 ± 496 | 3603 ± 24 | 41.4 ± 1.7 | 0.0 ± 0.0 s |
...
| C1 Controller + oracle (new upper bound) | 100.0 ± 0.0 % | 0 ± 0 | 2563 ± 80 | 8.0 ± 0.0 | 0.0 ± 0.0 s |
| C2 Controller + MA forecast | 99.9 ± 0.1 % | 10 ± 10 | 1259 ± 26 | 8.0 ± 0.0 | 0.0 ± 0.0 s |
| C3 Controller + reactive (trailing mean) | 99.9 ± 0.1 % | 10 ± 10 | 1259 ± 26 | 8.0 ± 0.0 | 0.0 ± 0.0 s |
| C4 Controller + trend forecast | 99.4 ± 0.3 % | 183 ± 118 | 2142 ± 35 | 21.8 ± 3.0 | 0.0 ± 0.0 s |
| C5 Controller + calibrated-noise forecast | 99.9 ± 0.1 % | 11 ± 10 | 3010 ± 112 | 55.6 ± 2.1 | 0.0 ± 0.0 s |
| C6 Sqrt-staffing + trend forecast | 100.0 ± 0.0 % | 0 ± 0 | 3969 ± 38 | 42.0 ± 2.0 | 0.0 ± 0.0 s |
...
| C1 Controller + oracle (new upper bound) | 100.0 ± 0.0 % | 0 ± 0 | 2817 ± 7 | 7.1 ± 0.3 | 0.0 ± 0.0 s |
| C2 Controller + MA forecast | 96.4 ± 0.1 % | 18663 ± 907 | 2590 ± 274 | 12.5 ± 0.8 | 0.4 ± 0.0 s |
| C3 Controller + reactive (trailing mean) | 96.4 ± 0.1 % | 18663 ± 907 | 2590 ± 274 | 12.5 ± 0.8 | 0.4 ± 0.0 s |
| C4 Controller + trend forecast | 98.5 ± 0.4 % | 8823 ± 741 | 2129 ± 97 | 37.0 ± 2.3 | 0.1 ± 0.0 s |
| C5 Controller + calibrated-noise forecast | 100.0 ± 0.0 % | 12 ± 21 | 2403 ± 93 | 40.2 ± 1.4 | 0.0 ± 0.0 s |
| C6 Sqrt-staffing + trend forecast | 98.9 ± 0.0 % | 6007 ± 223 | 3577 ± 11 | 51.0 ± 0.0 | 0.1 ± 0.0 s |
...
| C1 Controller + oracle (new upper bound) | 100.0 ± 0.0 % | 0 ± 0 | 3677 ± 89 | 21.0 ± 1.3 | 0.0 ± 0.0 s |
| C2 Controller + MA forecast | 98.8 ± 0.2 % | 248 ± 54 | 2098 ± 41 | 19.2 ± 0.6 | 0.0 ± 0.0 s |
| C3 Controller + reactive (trailing mean) | 98.8 ± 0.2 % | 248 ± 54 | 2098 ± 41 | 19.2 ± 0.6 | 0.0 ± 0.0 s |
| C4 Controller + trend forecast | 99.8 ± 0.2 % | 56 ± 75 | 3175 ± 24 | 32.5 ± 3.5 | 0.0 ± 0.0 s |
| C5 Controller + calibrated-noise forecast | 100.0 ± 0.1 % | 7 ± 11 | 4046 ± 67 | 54.1 ± 1.9 | 0.0 ± 0.0 s |
| C6 Sqrt-staffing + trend forecast | 100.0 ± 0.0 % | 0 ± 0 | 4608 ± 32 | 49.0 ± 1.5 | 0.0 ± 0.0 s |
...
| C1 Controller + oracle (new upper bound) | 99.9 ± 0.1 % | 56 ± 33 | 2837 ± 116 | 9.6 ± 1.9 | 0.0 ± 0.0 s |
| C2 Controller + MA forecast | 98.3 ± 0.4 % | 5592 ± 2273 | 2188 ± 156 | 11.1 ± 1.7 | 0.1 ± 0.0 s |
| C3 Controller + reactive (trailing mean) | 98.3 ± 0.4 % | 5592 ± 2273 | 2188 ± 156 | 11.1 ± 1.7 | 0.1 ± 0.0 s |
| C4 Controller + trend forecast | 99.2 ± 0.2 % | 2745 ± 1094 | 2404 ± 119 | 24.5 ± 3.5 | 0.0 ± 0.0 s |
| C5 Controller + calibrated-noise forecast | 99.8 ± 0.1 % | 160 ± 100 | 2862 ± 172 | 42.6 ± 3.5 | 0.0 ± 0.0 s |
| C6 Sqrt-staffing + trend forecast | 99.4 ± 0.1 % | 2000 ± 722 | 3649 ± 169 | 38.0 ± 5.0 | 0.0 ± 0.0 s |

_Aggregate over all 6 profiles × 8 seeds._

### Cooldown sweep (aggregate over all profiles × seeds)

Effect of `autoscaler_cooldown_seconds` on the dynamic strategies. Longer cooldown suppresses churn but slows the pool's response to ramps and spikes.

| Strategy | Cooldown (s) | SLA% | Unmet-RPS | #ScaleActions |
|---|---|---|---|---|
| S2 Predictive-realistic (MA forecast) | 0 | 73.6 ± 4.5 % | 32613 ± 7075 | 37.6 ± 10.2 |
| S2 Predictive-realistic (MA forecast) | 30 | 77.4 ± 3.0 % | 22646 ± 3677 | 17.9 ± 2.3 |
| S2 Predictive-realistic (MA forecast) | 60 | 77.2 ± 2.6 % | 29790 ± 6471 | 14.7 ± 1.7 |
| S2 Predictive-realistic (MA forecast) | 120 | 75.4 ± 3.0 % | 42518 ± 9481 | 10.6 ± 1.0 |
| S3 Reactive (trailing mean) | 0 | 73.6 ± 4.5 % | 32613 ± 7075 | 37.6 ± 10.2 |
| S3 Reactive (trailing mean) | 30 | 77.4 ± 3.0 % | 22646 ± 3677 | 17.9 ± 2.3 |
| S3 Reactive (trailing mean) | 60 | 77.2 ± 2.6 % | 29790 ± 6471 | 14.7 ± 1.7 |
| S3 Reactive (trailing mean) | 120 | 75.4 ± 3.0 % | 42518 ± 9481 | 10.6 ± 1.0 |
| S5 Naive-threshold | 0 | 99.4 ± 0.2 % | 2545 ± 1040 | 8.6 ± 1.5 |
| S5 Naive-threshold | 30 | 97.8 ± 0.8 % | 6995 ± 3018 | 8.0 ± 1.3 |
| S5 Naive-threshold | 60 | 96.4 ± 1.4 % | 11559 ± 5033 | 6.8 ± 1.2 |
| S5 Naive-threshold | 120 | 94.0 ± 2.0 % | 17635 ± 7121 | 4.7 ± 0.8 |
...
- **Target-based controller closes the gap (the headline result):** swapping the ±1 `decide()` rule for the multi-step, asymmetric-cooldown controller (`controllers.decide_target`) lifts the SAME moving-average signal from 77.2% (S2) to 98.3% (C2) — past the old perfect-foresight oracle (95.5%, S1). The binding constraint was the controller's slew rate (one instance per cooldown), not the forecast. With the controller fixed, the oracle signal (C1) reaches 99.9%.
- **A forward forecast now pays off (predictive > reactive):** under the SAME controller, the trend-extrapolating forecast (C4, 99.2%) beats the trailing-mean reactive signal (C3, 98.3%) — the moving-average S2≡S3 identity is broken once a forecaster actually projects ahead. C4 runs at over-prov cost 2404, versus naive-threshold's 4182 for 96.4% — higher SLA at lower cost. The SLA-vs-cost frontier (FRONTIER.md) maps the full trade-off.

...
| Autoscaling | [`autoscaler.md`](autoscaler.md) | The target-based controller (two sizing laws, asymmetric cooldowns, deadband) versus the live ±1 rule, and the strategy-bench results. Documents the not-yet-wired status honestly |

...
% TODO(vps-rerun): exact pool range and scaling-action count from the fresh VPS adaptive batch
...
the deployed trend-rule engine), the two agree about \BManAgree{} of the time, with the
disagreements being cases where Isolation Forest over-reacts.
